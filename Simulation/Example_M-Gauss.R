...
# function to generate n observations from a 2D truncated Gaussian
rtrunc_gaussian_2d <- function(n,
                               mean = c(0.5, 0.5),
                               sd = c(1, 1),
                               cov = 0.5,
                               lower = c(0, 0),
                               upper = c(1, 1)) {
  Sigma <- matrix(c(sd[1]^2, cov,
                    cov,     sd[2]^2), nrow = 2, byrow = TRUE)
  
  samples <- rtmvnorm(n = n,
                      mean = mean,
                      sigma = Sigma,
                      lower = lower,
                      upper = upper)
...
for (rid in 1:runtime) {
  ...
  dat <- makedata_fun_2d(n = 500, m = model$m, alpfun = model$alpfun, beta = model$beta,
...
save(Res_ex3_n500, file = 'Res_Ex3_tGaus.RData')
...
cat('\n\n############################################# 
############################################# 
Example 3 compare  n = 500', '\n\n')

n = 500

Res_SVCoef_ex3_n500 = NULL
Res_VCoef_ex3_n500 = NULL
Res_lm_ex3_n500 = NULL
Res_seqMS_ex3_n500 = NULL
...
for (rid in 1:runtime) {
  ...
  Res_SVCoef_ex3_n500[[rid]] = res_SVCoef
  Res_VCoef_ex3_n500[[rid]] = res_VCoef
  Res_lm_ex3_n500[[rid]] = res_lm
  Res_seqMS_ex3_n500[[rid]] = res_seqMS
...
save(Res_SVCoef_ex3_n500, Res_VCoef_ex3_n500, Res_lm_ex3_n500, Res_seqMS_ex3_n500,
     file = 'Res_Ex3_tGaus_compare.RData')
...
for (rid in 1:runtime) {
  ...
  dat <- makedata_fun_2d(n = 1000, m = model$m, alpfun = model$alpfun, beta = model$beta,
                         rdist = rtrunc_gaussian_2d, t_corr = T,
                         covrate = 0.2, noisd = sqrt(0.5),
                         draw = F)
...
save(Res_ex3_n500, Res_ex3_n1000, file = 'Res_Ex3_tGaus.RData')
...
cat('\n\n############################################# 
############################################# 
Example 3 compare  n = 1000', '\n\n')

n = 1000

Res_SVCoef_ex3_n1000 = NULL
Res_VCoef_ex3_n1000 = NULL
Res_lm_ex3_n1000 = NULL
Res_seqMS_ex3_n1000 = NULL
...
for (rid in 1:runtime) {
  ...
  Res_SVCoef_ex3_n1000[[rid]] = res_SVCoef
  Res_VCoef_ex3_n1000[[rid]] = res_VCoef
  Res_lm_ex3_n1000[[rid]] = res_lm
  Res_seqMS_ex3_n1000[[rid]] = res_seqMS
  ...
  Res_SVCoef_ex3_n1000[[rid]] = resCP
...
save(Res_SVCoef_ex3_n500, Res_VCoef_ex3_n500, Res_lm_ex3_n500, Res_seqMS_ex3_n500,
     Res_SVCoef_ex3_n1000, Res_VCoef_ex3_n1000, Res_lm_ex3_n1000, Res_seqMS_ex3_n1000,
     file = 'Res_Ex3_tGaus_compare.RData')
...
for (rid in 1:runtime) {
  ...
  dat <- makedata_fun_2d(n = 2000, m = model$m, alpfun = model$alpfun, beta = model$beta,
                         rdist = rtrunc_gaussian_2d, t_corr = T,
                         covrate = 0.2, noisd = sqrt(0.5),
                         draw = F)
...
save(Res_ex3_n500, Res_ex3_n1000, Res_ex3_n2000, file = 'Res_Ex3_tGaus.RData')
...
cat('\n\n############################################# 
############################################# 
Example 3 compare  n = 2000', '\n\n')

n = 2000

Res_SVCoef_ex3_n2000 = NULL
Res_VCoef_ex3_n2000 = NULL
Res_lm_ex3_n2000 = NULL
Res_seqMS_ex3_n2000 = NULL
...
for (rid in 1:runtime) {
  ...
  Res_SVCoef_ex3_n2000[[rid]] = res_SVCoef
  Res_VCoef_ex3_n2000[[rid]] = res_VCoef
  Res_lm_ex3_n2000[[rid]] = res_lm
  Res_seqMS_ex3_n2000[[rid]] = res_seqMS
  ...
  Res_SVCoef_ex3_n2000[[rid]] = resCP
...
save(Res_SVCoef_ex3_n500, Res_VCoef_ex3_n500, Res_lm_ex3_n500, Res_seqMS_ex3_n500,
     Res_SVCoef_ex3_n1000, Res_VCoef_ex3_n1000, Res_lm_ex3_n1000, Res_seqMS_ex3_n1000,
     Res_SVCoef_ex3_n2000, Res_VCoef_ex3_n2000, Res_lm_ex3_n2000, Res_seqMS_ex3_n2000,
     file = 'Res_Ex3_tGaus_compare.RData')
